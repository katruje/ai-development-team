...
class Agent(AgentProtocol, abc.ABC):
    ...
    Specific agent implementations should subclass this and implement the abstract methods.
    """
    ...
    async def process_message(self, message: AgentMessage, context: AgentContext) -> AgentMessage:
        ...
        This base implementation adds the incoming message to the context's message history
        and delegates to _process_message for the actual processing.
