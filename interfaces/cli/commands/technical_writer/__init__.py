...
def generate_docs(
    target_path: str = typer.Argument(
        ...,
        help="Path to the Python file or package to generate documentation for. "
            "This should be the path to the implementation code that needs documentation."
    ),
    ...
    console.print(f"\n[bold blue]Generating {output_format} documentation for {target_path}...[/]\n")
